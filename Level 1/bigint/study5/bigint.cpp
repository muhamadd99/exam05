...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/29 11:10:20 by mbani-ya          #+#    #+#             */
/*   Updated: 2025/11/29 16:54:12 by mbani-ya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bigint	bigint::operator+(const bigint& other) const
{
	...
	int carry = 0;
	bigint	res;
	size_t	size = std::max(other.digits.size(), digits.size());
...
bigint	bigint::operator>>(int shift) const
{
	...
	if (shift >= (int)tmp.digits.size())
		return bigint(0);
	tmp.digits.erase(tmp.digits.begin(), tmp.digits.begin() + shift);
	return tmp;
}
