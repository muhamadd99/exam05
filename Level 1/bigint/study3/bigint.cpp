...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/27 23:15:01 by mbani-ya          #+#    #+#             */
/*   Updated: 2025/11/28 21:17:42 by mbani-ya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//if 0 condition no point of pushing
//make new and use insert
...
bigint&	bigint::operator<<=(const bigint& other)
{
	*this = *this << other.to_int(); //*this <<= other.to_int();
	return *this;
}
