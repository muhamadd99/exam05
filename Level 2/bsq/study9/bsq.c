...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/08 15:14:25 by mbani-ya          #+#    #+#             */
/*   Updated: 2025/12/08 16:30:49 by mbani-ya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	int res = fscanf(file, "%d %c %c %c", &e->nlines, &e->empty, 
		&e->obstacle, &e->full);
	if (res != 4)
		return -1;
	if (e->nlines <= 0)
