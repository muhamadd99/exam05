...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/09 10:27:44 by mbani-ya          #+#    #+#             */
/*   Updated: 2025/12/09 11:54:04 by mbani-ya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	loadMap(FILE* file, t_element* element, t_map* map)
{
	...
	//loop line, check newline, decrrement read, ft_substr, check width
